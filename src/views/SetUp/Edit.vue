<template>
	<div class="table">
		<div class="list">账户资料</div>
		<div class="floor1">
			<span style="margin-right: 5px;">用户名</span>
			<el-input disabled v-model="input" placeholder="admin" style="width: calc(100% - 60px);"></el-input>
		</div>
		<div class="floor1">
		...
		<div class="floor1">
			<div class="block">
				<span class="demonstration" style="margin-right: 5px; margin-left: 15px;">角色</span>
